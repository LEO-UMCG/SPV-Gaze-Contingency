...
class Representer(torch.nn.Module):
    ...
    def __init__(self, arryaOut=False):
        ...
        self.seq1 = nn.Sequential(nn.Conv2d(3,8,3,1,1),
                                   nn.BatchNorm2d(8),
                                   nn.LeakyReLU(inplace=True))
        self.seq2 = nn.Sequential(nn.Conv2d(8,16,3,1,1),
                                   nn.BatchNorm2d(16),
                                   nn.LeakyReLU(inplace=True), nn.MaxPool2d(2))
        self.seq3 = nn.Sequential(nn.Conv2d(16,32,3,1,1),
                                   nn.BatchNorm2d(32),
                                   nn.LeakyReLU(inplace=True), nn.MaxPool2d(2))
        self.seq4 = nn.Sequential(nn.Conv2d(32,64,3,1,1),
                                   nn.BatchNorm2d(64),
                                #    nn.LeakyReLU(inplace=True), nn.MaxPool2d(2))
                                nn.LeakyReLU(inplace=True))
        ...
        self.seq5 = nn.Sequential(nn.Conv2d(64,32,3,1,1),
                                   nn.BatchNorm2d(32),
                                   nn.LeakyReLU(inplace=True), nn.MaxPool2d(2))
        
        self.seq6 = nn.Sequential(nn.Conv2d(32,16,3,1,1),
                                   nn.BatchNorm2d(16),
                                   nn.LeakyReLU(inplace=True))
        
        self.seq7 = nn.Sequential(nn.Conv2d(16,8,3,1,1),
                                   nn.BatchNorm2d(8),
                                   nn.LeakyReLU(inplace=True))
        
        self.conv8 = nn.Conv2d(8,3,3,1,1)
        self.conv9 = nn.Conv2d(3,1,3,1,1)
